...
export default function InterviewModeSelection({ onStartSession }: InterviewModeSelectionProps) {
...
const mockQuestions: InterviewQuestion[] = [
  ...
  },
  {
    ...
    description: 'Find all orders with customer information for orders placed in the last 30 days.',
...
CREATE TABLE orders (
  ...
  },
  {
    ...
    description: 'Calculate running total of sales by month for each product category.',
